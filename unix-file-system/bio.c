// ============================================================================
// bio.c - low level Block I/O functions
// ============================================================================
...
i32 bioRead(i32 dbn, void* buf) {
  ...
  i32 boff = dbn * BYTESPERBLOCK;                             // gets you to the block you want to be at (i.e., each block is 512 bytes in size, and if you want to get to block 3, its 3 * 512)
